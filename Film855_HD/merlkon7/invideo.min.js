var invideo = {
    ...
    adsTemplate: function() {
        ...
        btn.style.cssText = 'padding:5px 0;color:#fff;border:1px solid #fff;font-size:16px;background:'+this.settings.btn.color+';width:120px;margin:11px -65px 0;border-radius:5px;cursor:pointer;position:absolute;top: 100%;left: 50%';
        ...
        if(this.settings.ads.url2 !=  "") {
            ...
            btn.style.margin = "20px -60px 0";
        }
        iframeWrapper.appendChild(btn);

        setTimeout(function() {
            document.getElementById('adbe-square-invideo').style.background = "#fff";
        }, 4500);
