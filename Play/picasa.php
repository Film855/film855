...
image: 'https://film855.github.io/film855/Film855_HD/Player%20Cover%20v2.png',
		sources: [<?php echo $file = picasa_direct($u); ?>],
	tracks: [{ 
		    file: '/embed/getsub.php?linksub=<?php echo $suben; ?>', 
		    label: 'English', 
		    kind: 'captions',
		    "default":true
		  }],
     captions: {
        color: '#ffffff',
        fontSize: 15,
        fontFamily: 'cursive, sans-serif, Verdana',
        fontOpacity: 100,
        backgroundOpacity: 0,
...
playerInstance.addButton(
									...
									function() {
										...
										if(kcQ < 0) { kcQ =0;}
										var kF = kI.sources[kcQ].file+"?itag="+kcQ+"&type=video/mp4&title=Film855HD.Com";
