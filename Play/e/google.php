...
$u = "https://drive.google.com/file/d/0B5UGV7pNDWXRU1d3T3NpUE9TSms/view?usp=sharing";
...
?>],
	tracks: [{ 
		    file: 'http://wpplayer.org/e/getsub.php?linksub=<?php 
			$suben ='';
			echo $suben; ?>', 
		    label: 'English', 
		    kind: 'captions',
						...
						playerInstance.addButton(
									...
									function() {
										...
										if(kI.sources[kcQ].file.lastIndexOf('redirector.googlevideo.com') > 0) {
											var kF = kI.sources[kcQ].file+"&title=GoogleVideoName";
										} 
