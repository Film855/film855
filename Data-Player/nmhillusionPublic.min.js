...
function loadLink(b,a){if(!nmh.mobile){var c=nmhd.gid("bigframe");c&&c.parentNode.removeChild(c);if(void 0!==b){a||(a=event);var c=a.screenX<.7*screen.availWidth?a.screenX-20:a.screenX-.4*screen.availWidth,d=a.screenY<.6*screen.availHeight?a.screenY-40:a.screenY-430,e=nmhd().createElement("bigframe"),f=b.toString(),g=f,h=nmhd().createElement("div"),k=-1!==b.toString().search(/\?/)?"&m=1":"?m=1",c=c+"px",d=d+"px";-1!==f.search(location.hostname)&&(g=f=f.replace(location.hostname,"nmhillusion.blogspot.com"));
-1!==f.search(/\/\/nmhillusion.blogspot.com/)&&(g=f+k);e.src=g;h.id="bigframe";e.onerror=function(a){nmhd.gid("bigframe").innerHTML="<b>! Kh\u00f4ng th\u1ec3 xem tr\u01b0\u1edbc link n\u00e0y !</b>"};h.innerHTML="<b>[Xem tr\u01b0\u1edbc li\u00ean k\u1ebft] | <a target='_blank' href='"+f+"'>[\u0110i \u0111\u1ebfn li\u00ean k\u1ebft n\u00e0y]</a></b><br/><div id='loadingLink'><div class='spinner'></div><br/>\u0110ang t\u1ea3i...</div>";h.style="position: fixed; top: "+d+";left:"+c+";";e.style="width:calc(100% - 22px);height:400px;position: absolute;bottom: 5px;";
h.appendChild(e);nmhd().body.appendChild(h);$("#bigframe iframe").load(function(){nmhd.gid("loadingLink").parentNode.removeChild(nmhd.gid("loadingLink"))})}}};
